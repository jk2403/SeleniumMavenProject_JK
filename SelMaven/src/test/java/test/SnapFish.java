...
public class SnapFish {
	...
	//	System.out.println("Instagram text is: "+Instagram.getText());
		Thread.sleep(2000);
           ...
           // System.out.println("Child Window Name is: "+ChildWindow);
               ...
               System.out.println("1st window page title is: "+driver.getTitle());
                ...
                if( ChildwindowInstagram.equalsIgnoreCase(driver.getTitle()))
                {
            		...
            		System.out.println("Submitted Click Successfully");
                }
                ...
                break; //After switch to Instagram Childwindow it breaks.
            }
        }
